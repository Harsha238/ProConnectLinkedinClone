                                        ...
                                        <div>
                                            <div style={{display:"flex",gap:"1.2rem",justifyContent:"space-between"}}>
                                                <p style={{ fontWeight: "bold" }}>{post.userId.name}</p>
                                                {
                                                    ...
                                                    <div onClick={async() => {
                                                        ...
                                                        <svg style={{height:"1.3rem", color:"red"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                            ...
                                            <div className={styles.optionsContainer}>
                                                ...
                                                <div onClick={() => {
                                                    ...
                                                    const url=encodeURIComponent("ashu")
